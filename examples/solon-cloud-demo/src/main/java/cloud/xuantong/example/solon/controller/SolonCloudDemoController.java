package cloud.xuantong.example.solon.controller;
 ...
 */
@Controller
public class SolonCloudDemoController {
    private static final Logger logger = LoggerFactory.getLogger(SolonCloudDemoController.class);
