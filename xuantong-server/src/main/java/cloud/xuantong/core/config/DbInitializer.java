...
public class DbInitializer {
    ...
    private static IllegalStateException incompatibleSchema() {
        return new IllegalStateException(
                "Detected an incompatible Xuantong 1.x database. Xuantong 2.0 does not "
                        + "migrate legacy schemas. Use the default ./data/xuantong-2 database, "
                        + "or configure a new empty database with XUANTONG_DB_URL.");
    }
}
