...
public class NimbusConfigValueProcessor implements BeanPostProcessor {

    private final ObjectProvider<NimBusClient> nimBusClientProvider;
    private final Map<String, List<FieldValueHolder>> configKeyToFields = new ConcurrentHashMap<>();

    public NimbusConfigValueProcessor(ObjectProvider<NimBusClient> nimBusClientProvider) {
        ...
        ReflectionUtils.doWithFields(clazz, field -> {
            ...
            if (valueAnnotation != null) {
                ...
                if (value.startsWith("${") && value.endsWith("}")) {
                    ...
                    // 添加监听器
                    NimBusClient client = nimBusClientProvider.getIfAvailable();
                    if (client != null) {
